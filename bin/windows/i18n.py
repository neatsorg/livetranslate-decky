...
STRINGS = {
    "ja": {
        ...
        "settings.ocr_engine_windows_ocr": "Windows標準OCR",
        ...
        "ocr_lang.uninstall_button": "削除",
        "ocr_lang.installing_status": "インストール中… (UACの確認画面が出たら許可してください)",
        "ocr_lang.uninstalling_status": "削除中… (UACの確認画面が出たら許可してください)",
        ...
        "ocr_lang.install_exit_error": "インストールコマンドがエラー終了しました (exit code {code})",
        "ocr_lang.install_success": "インストールが完了しました",
        "ocr_lang.install_unconfirmed": "コマンドは完了しましたが、インストール状態を確認できませんでした",
        "ocr_lang.uninstall_exit_error": "削除コマンドがエラー終了しました (exit code {code})",
        "ocr_lang.uninstall_success": "削除が完了しました",
        "ocr_lang.uninstall_unconfirmed": "コマンドは完了しましたが、削除できたか確認できませんでした",
    ...
    "en": {
        ...
        "settings.ocr_engine_windows_ocr": "Windows built-in OCR",
        ...
        "ocr_lang.uninstall_button": "Remove",
        "ocr_lang.installing_status": "Installing... (approve the UAC prompt if one appears)",
        "ocr_lang.uninstalling_status": "Removing... (approve the UAC prompt if one appears)",
        ...
        "ocr_lang.install_exit_error": "The install command exited with an error (exit code {code})",
        ...
        "ocr_lang.uninstall_exit_error": "The remove command exited with an error (exit code {code})",
        "ocr_lang.uninstall_success": "Removed successfully",
        "ocr_lang.uninstall_unconfirmed": "The command finished, but the removal couldn't be confirmed",
